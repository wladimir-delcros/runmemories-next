...
const testimonials = [
  {
    quote: "J'ai fait mon premier marathon à 45 ans. Ce poster est accroché dans mon bureau depuis 2 ans. Chaque fois que je le regarde, je me rappelle de chaque kilomètre.",
    name: "Marie-Claire D.",
  ...
  {
    quote: "Cadeau parfait pour un ami ultra-traileur. Il m'a dit que c'était le meilleur cadeau qu'il ait reçu depuis des années. L'affiche de son UTMB est maintenant la pièce maîtresse de son salon.",
    name: "Thomas B.",
    role: "Coureur trail",
  ...
  {
    quote: "La qualité du poster est bluffante. Les couleurs, le détail de la carte... j'ai reçu des compliments de tout le monde. On me demande souvent où j'ai trouvé ça.",
    name: "Lucas M.",
  ...
  {
    quote: "Super simple à utiliser. J'ai importé mon GPX depuis Garmin en 30 secondes, personnalisé le poster en 10 minutes, et téléchargé le PDF. Résultat parfait.",
    name: "Sophie L.",
    role: "Trailrunner",
    event: "SaintéLyon 2023",
    rating: 5,
    highlight: "Téléchargé en 10 min",
  },
  {
    quote: "Je suis graphiste et j'ai été impressionné par la qualité du rendu. Le tracé GPX sur la carte est vraiment propre et le résultat final est pro. Je recommande à tout le monde.",
    name: "Antoine R.",
  ...
  {
    quote: "On était 4 amis à finir notre premier marathon ensemble. On a chacun fait notre poster avec le même parcours mais des couleurs différentes. C'est devenu une tradition après chaque course.",
...
export function Testimonials() {
  ...
  const stats = t.raw("stats") as Array<{ icon: string; label: string; suffix: string }>;
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-white/30 text-sm">{t("ratingText")}</span>
          </motion.div>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-white/5">
                ...
                <div>
                  ...
                  <div className="text-[#FC4C02]/60 text-xs font-medium mt-0.5">{t2.event}</div>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          {[
            { icon: "🏆", label: stats[0].label, value: 10000, suffix: stats[0].suffix },
            { icon: "⭐", label: stats[1].label, value: 4.9, suffix: stats[1].suffix, decimals: 1 },
            { icon: "🌍", label: stats[2].label, value: 15, suffix: stats[2].suffix },
            { icon: "🔄", label: stats[3].label, value: 96, suffix: stats[3].suffix },
          ].map((stat, i) => (
