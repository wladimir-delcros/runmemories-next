...
export function HowItWorks() {
  ...
  const steps = t.raw("steps") as Array<{ number: string; title: string; desc: string; detail: string }>;
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          >
            ...
            <br />
            <span className="text-white/60 text-3xl sm:text-4xl font-bold">{t("headlineSub")}</span>
          </motion.h2>
            ...
            <motion.div key={i} variants={item}>
              <div className="relative bg-white/[0.03] border border-white/8 rounded-2xl p-7 h-full hover:border-[#FC4C02]/30 transition-all duration-300 card-hover group">
                ...
                <div className="bg-white/[0.03] border border-white/5 rounded-lg px-4 py-3">
                  <p className="text-white/35 text-xs leading-relaxed italic">ℹ {step.detail}</p>
                </div>
                {i < 2 && (
