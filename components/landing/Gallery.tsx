...
const posterStyles = [
  {
    ...
    denivelé: "+284m",
    style: "Soleil",
    // Urban loop — city boulevards, rectangular blocks
    trace: "M35,118 L22,108 L18,95 L22,82 L35,74 L48,76 L60,72 L72,62 L78,50 L72,38 L62,28 L64,18 L72,14 L80,20 L76,34 L65,42 L70,55 L78,65 L72,80 L60,88 L46,94 L42,108 L35,118",
    startDot: [35, 118] as [number, number],
    endDot: [72, 14] as [number, number],
  },
  {
    bg: "#0f0f1a",
    textColor: "#FC4C02",
    ...
    denivelé: "+10000m",
    style: "Nuit",
    // Mountain switchbacks — sharp zigzag ascending
    trace: "M50,118 L18,105 L46,92 L14,79 L44,66 L16,53 L46,40 L18,27 L50,15",
    startDot: [50, 118] as [number, number],
    endDot: [50, 15] as [number, number],
  },
  {
    bg: "#0a1628",
    textColor: "#60a5fa",
    ...
    denivelé: "+480m",
    style: "Minuit",
    // Long point-to-point with bridge crossings
    trace: "M28,118 L25,105 L30,93 L42,85 L55,80 L68,72 L74,60 L68,48 L72,36 L65,26 L70,16 L72,12",
    startDot: [28, 118] as [number, number],
    endDot: [72, 12] as [number, number],
  },
  {
    bg: "#f0ede6",
    textColor: "#1a1a1a",
    ...
    denivelé: "+125m",
    style: "Paper",
    // River loop — follows the Garonne, oval shape
    trace: "M62,118 L72,108 L80,96 L82,82 L76,68 L62,60 L50,57 L38,60 L24,68 L18,82 L20,96 L28,108 L42,116 L62,118",
    startDot: [62, 118] as [number, number],
    endDot: [62, 118] as [number, number],
  },
  {
    bg: "#1e0a3c",
    textColor: "#c084fc",
    ...
    denivelé: "+2450m",
    style: "Violet",
    // Long diagonal point-to-point with climbs
    trace: "M72,118 L65,107 L70,95 L60,84 L52,74 L56,62 L48,52 L40,40 L44,28 L36,17 L30,13",
    startDot: [72, 118] as [number, number],
    endDot: [30, 13] as [number, number],
  },
  {
    bg: "#071a04",
    textColor: "#4ade80",
    ...
    denivelé: "+3200m",
    style: "Forêt",
    // Lake circuit — follows the lake contour with mountain detours
    trace: "M50,118 L28,112 L16,98 L12,82 L18,68 L30,58 L25,46 L32,34 L44,24 L56,20 L70,26 L78,38 L75,52 L68,62 L78,72 L80,88 L72,102 L62,114 L50,118",
    startDot: [50, 118] as [number, number],
    endDot: [50, 118] as [number, number],
  },
];
...
function MapBackground({ poster }: { poster: (typeof posterStyles)[0] }) {
  return (
    ...
    >
      ...
      {/* Water body */}
      <path
        d="M0,58 Q25,52 50,60 Q75,68 100,60 L100,76 Q75,84 50,76 Q25,68 0,76 Z"
        fill={poster.waterColor}
        opacity="0.5"
      />
      {/* Parks/blocks */}
  ...
  return (
    ...
    >
      <Link href="https://app.runmemories.com" target="_blank" rel="noopener noreferrer">
        <div
          className="rounded-xl overflow-hidden poster-shadow relative"
        ...
        >
          ...
          >
            <svg viewBox="0 0 100 130" className="w-full h-full">
              ...
              />
              {/* Start dot */}
              <circle cx={poster.startDot[0]} cy={poster.startDot[1]} r="4.5" fill={poster.traceColor} opacity="0.9" />
              <circle cx={poster.startDot[0]} cy={poster.startDot[1]} r="8" fill={poster.traceColor} opacity="0.15" />
              {/* End dot */}
              <circle cx={poster.endDot[0]} cy={poster.endDot[1]} r="2.5" fill={poster.traceColor} opacity="0.6" />
            </svg>
          </div>
          ...
          <div
            ...
            style={{
              background: `linear-gradient(to top, ${poster.bg} 70%, transparent)`,
            }}
          >
            <div
            ...
            <div
              className="font-heading font-bold text-[9px] tracking-[0.25em] uppercase mt-0.5 opacity-70"
              style={{ color: poster.textColor }}
            >
              {poster.event}
            </div>
            <div
              className="flex justify-between items-center mt-1.5 text-[9px] opacity-50"
              style={{ color: poster.textColor }}
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-20">
          ...
          >
            ...
            <br />
            <span className="text-white/60 text-3xl font-bold">{t("headlineSub")}</span>
          </motion.h2>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <p className="text-white/60 text-sm mb-4">{t("ctaBottom")}</p>
          <Link
            href="https://app.runmemories.com"
            target="_blank"
